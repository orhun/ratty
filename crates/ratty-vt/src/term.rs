...
pub struct Attrs {
    ...
    inverse: Option<bool>,
    // ratty-vt: blink.
    blink: Option<crate::attrs::Blink>,
...
impl Attrs {
    ...
    // ratty-vt: blink.
    pub fn blink(mut self, blink: crate::attrs::Blink) -> Self {
    ...
    pub fn underline_color(mut self, color: crate::Color) -> Self {
...
impl BufWrite for Attrs {
    ...
    fn write_buf(&self, buf: &mut Vec<u8>) {
        ...
        if let Some(blink) = self.blink {
            match blink {
                crate::attrs::Blink::None => write_param!(25),
                crate::attrs::Blink::Slow => write_param!(5),
                crate::attrs::Blink::Rapid => write_param!(6),
            }
        }
