...
//!
//! This crate is a fork of the [`vt100`](https://github.com/doy/vt100-rust)
...
//! verbatim in this crate's `LICENSE` and the upstream copyright notice
//! applies to everything under this directory. See this crate's `README.md`
...
//! separate crate: it models the screen grid, scrollback, cell attributes,
...
// safe; retain those documented invariants. The remaining allows mirror
// upstream's own `lib.rs`, plus
