...
pub struct WrappedScreen<CB: crate::ratty_vt::callbacks::Callbacks = ()> {
    pub screen: crate::ratty_vt::screen::Screen,
    pub callbacks: CB,
}
...
impl<CB: crate::ratty_vt::callbacks::Callbacks> WrappedScreen<CB> {
    pub fn new_with_callbacks(rows: u16, cols: u16, scrollback_len: usize, callbacks: CB) -> Self {
        Self {
            screen: crate::ratty_vt::screen::Screen::new(
                crate::ratty_vt::grid::Size { rows, cols },
                scrollback_len,
            ),
            callbacks,
        }
...
impl<CB: crate::ratty_vt::callbacks::Callbacks> vte::Perform for WrappedScreen<CB> {
    ...
    fn csi_dispatch(&mut self, params: &vte::Params, intermediates: &[u8], _ignore: bool, c: char) {
        let unhandled = |screen: &mut crate::ratty_vt::screen::Screen| {
