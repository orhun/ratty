...
// ratty-vt: an atomic instead of upstream's `static mut`, which edition 2024
// rejects taking references to.
...
pub fn compare_screens(got: &vt100::Screen, expected: &vt100::Screen) -> bool {
