...
fn formatted() {
    ...
    parser.process(b"\x1b[2;2H\x1b[38;2;123;213;231mu\x1b[38;5;254mu\x1b[39mx");
    helpers::contents_formatted_reproduces_screen(parser.screen());
...
fn rows() {
    ...
    parser.process(b"\x1b[31mfoo\x1b[10;10H\x1b[32mbar\x1b[20;20H\x1b[33mbaz");
...
fn diff_basic() {
    ...
    helpers::assert_contents_diff_reproduces_state_from_screens(&screen1, &screen2);

    parser.process(b"\x1b[H\x1b[31mfoo");
    let screen3 = parser.screen().clone();
    assert_eq!(screen3.contents_diff(&screen2), b"\x1b[H\x1b[31mfoo");
    helpers::assert_contents_diff_reproduces_state_from_screens(&screen2, &screen3);
    ...
    helpers::assert_contents_diff_reproduces_state_from_screens(&screen3, &screen4);

    parser.process(b"\x1b[1;8H\x1b[X");
    let screen5 = parser.screen().clone();
    assert_eq!(screen5.contents_diff(&screen4), b"\x1b[1;8H\x1b[X");
    helpers::assert_contents_diff_reproduces_state_from_screens(&screen4, &screen5);
}
...
// ratty-vt: the diff_crawl tests are omitted; they need the 30 MB
// tests/data/crawl fixture set, which is not vendored.
